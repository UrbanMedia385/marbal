      ...
      <div className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-black">
        ...
        <div className="relative z-10 text-center px-4 mt-[-50px]">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.6 }} className="flex flex-col sm:flex-row gap-5 items-center justify-center w-full">
            <button className="flex items-center gap-3 bg-[#0E5543]  text-white px-8 py-4 rounded-md font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
              <FaPlay className="text-sm" /> Explore Our Process
            </button>
            <button className="flex items-center gap-3 bg-transparent border-2 border-white  hover:text-[#0E5543] text-white px-8 py-4 rounded-md font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
              View Collection
            </button>
          </motion.div>
        </div>
